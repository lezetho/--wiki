...
For a more detailed comparison, consult the [Unifier vs. Unifier Micro comparison](../../compare/full-vs-micro).
...
<img src="../../assets/images/Screenshot%202024-05-03%20at%2014.24.39.png" alt="" />
...
<CardGroup cols={2}>
  <Card title="Unifier" icon="rocket" href="./selfhosted/unifier">
    Fast, versatile and flexible. The full-fledged version of Unifier built for communities.
  </Card>
  <Card title="Unifier Micro" icon="feather" href="./selfhosted/unifier-micro">
    A much lighter version of Unifier made for those wanting to give bridges a try.
  </Card>
</CardGroup>
