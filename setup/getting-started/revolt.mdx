...
<Frame caption="private-1s1sxkl1eu is the room name, 3d is the validity of the invite, and 1 is the maximum usage of the invite. "><img src="../../assets/images/image (30).png" alt="" /></Frame>
...
<Frame caption="For Public Rooms, type in the Room name."><img src="../../assets/images/image (15).png" alt="" /></Frame>

<Frame caption="For Private Rooms, type in the Room invite. You can use the Room name if you're running the command in the same server you created the Room in."><img src="../../assets/images/image (16).png" alt="" /></Frame>
