...
Unifier's bootloader lets you set custom Python binary paths, if the default Python binary doesn't suit your needs. To learn how to configure the bootloader, please read [Configuring the bootloader](./bootloader-config).
