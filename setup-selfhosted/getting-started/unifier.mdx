...
<CardGroup cols={2}>
  <Card title="Moderation tools" icon="shield" href="../../guides/bridge/moderation-tools.md">
  ...
  <Card title="Global Emojis" icon="face-laugh-beam" href="../../guides/bridge/global-emojis.md">
    Global Emojis lets you use emojis from participating servers even on paywalled platforms.
  </Card>
  <Card title="Upgrading Unifier" icon="circle-arrow-up" href="../upgrading-unifier">
