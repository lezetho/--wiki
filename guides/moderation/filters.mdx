---
title: Filters
description: Automated moderation for your bridge, made easy.
icon: flag
---
...
If a Filter is triggered too many times in the same Room, Unifier may enable [Under Attack Mode](./under-attack-mode) for your server, if [Automatic UAM](./under-attack-mode#automatic-uam) is enabled.
